...
def setup_training_loop_kwargs(
    ...
    augpipe_specs = {
        ...
        # !!!
        'bgf_cnc': dict(xflip=1, rotate90=1, xint=1, scale=1, rotate=1, aniso=1, xfrac=1, contrast=0.23, imgfilter=1,
                        noise=0.11, cutout=0.11),
        'gf_bnc': dict(xflip=.5, xint=.5, scale=1, rotate=1, aniso=1, xfrac=1, rotate_max=.25, imgfilter=1, noise=.5,
                       cutout=.5),  # aug0
    }
    ...
    resume_specs = {
        'ffhq256': 'https://nvlabs-fi-cdn.nvidia.com/stylegan2-ada-pytorch/pretrained/'
                   'transfer-learning-source-nets/ffhq-res256-mirror-paper256-noaug.pkl',
        'ffhq512': 'https://nvlabs-fi-cdn.nvidia.com/stylegan2-ada-pytorch/pretrained/'
                   'transfer-learning-source-nets/ffhq-res512-mirror-stylegan2-noaug.pkl',
        'ffhq1024': 'https://nvlabs-fi-cdn.nvidia.com/stylegan2-ada-pytorch/pretrained/'
                    'transfer-learning-source-nets/ffhq-res1024-mirror-stylegan2-noaug.pkl',
        'celebahq256': 'https://nvlabs-fi-cdn.nvidia.com/stylegan2-ada-pytorch/pretrained/'
                       'transfer-learning-source-nets/celebahq-res256-mirror-paper256-kimg100000-ada-target0.5.pkl',
        'lsundog256': 'https://nvlabs-fi-cdn.nvidia.com/stylegan2-ada-pytorch/pretrained/'
...
@click.command()
@click.pass_context
@click.option('--train_dir', default='train', help='Root directory for training results [default: train]',
              metavar='DIR')
# data
...
@click.option('--cond', is_flag=True, help='Train conditional model based on dataset labels [default: false]',
              metavar='BOOL')
# training
...
@click.option('--lrate', type=float, help='Override learning rate')
...
@click.option('--aug', default='ada', help='Augmentation mode [default: ada]',
...
# @click.option('--augpipe', default='bgc', help='Augmentation pipeline', type=click.Choice(['blit', 'geom', 'color',
# 'filter', 'noise', 'cutout', 'bg', 'bgc', 'bgcf', 'bgcfn', 'bgcfnc']))
