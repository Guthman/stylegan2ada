...
parser.add_argument('--splitfine', type=float, default=0,
                    help='multi latent frame split edge sharpness (0 = smooth, higher => finer)')
...
def generate():
    ...
    if a.latmask is None:
        ...
        if a.verbose is True:
            print(' Latent blending with mask', a.latmask)
        n_mult = 2
    ...
    for i in range(n_mult):
        lat_tmp = latent_anima((1, Gs.z_dim), a.frames, a.fstep, cubic=a.cubic, gauss=a.gauss,
